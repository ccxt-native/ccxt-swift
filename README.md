...
dependencies: [
    ...
    // .package(url: "https://github.com/ccxt-native/swift-intel-simulator", from: "1.0.0"),
    // .package(url: "https://github.com/ccxt-native/swift-arm-simulator", from: "1.0.0"),
],
targets: [
    .binaryTarget(
        name: "CCXTCore",
...
#### swift vs swift-arm-simulator vs swift-intel-simulator

https://github.com/ccxt-native/swift

    - Contains binaries for iOS (live), macOS (live), and **both** ARM & Intel simulators.
    - Works on all iOS, Macs, and simulators
    - Use if size of the package is not a concern

https://github.com/ccxt-native/swift-arm-simulator

    - Contains binaries for iOS(live), MacOS(live) and arm simulators
    - Will not work on Xcode simulators for intel macs
    - Use if you are developing on only arm macs
    - Your built application will still work on all iPhones and Macs

https://github.com/ccxt-native/intel-arm-simulator

    - Contains binaries for iOS(live), MacOS(live) and intel simulators
    - Will not work on Xcode simulators for arm macs
    - Use if you are developing on only intel macs
    - Your built application will still work on all iPhones and Macs

**If you are confused, use https://github.com/ccxt-native/swift**
